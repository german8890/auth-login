...
type Encode func(ctx context.Context, r *http.Request, request interface{}) error

type Decode func(ctx context.Context, response *http.Response) (interface{}, error)
